# IGDMo
**Official code**: _Instruction-guided distribution maximization for general few-shot intent recognition_ (Published on IEEE Transactions on Pattern Analysis and Machine Intelligence).  
## Abstract
